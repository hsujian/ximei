...
static void *ngx_http_demo_create_conf(ngx_conf_t *cf);
...
{/*{{{*/
    ...
    { ngx_string("demo"), //The command name, it MUST BE the same as nginx.conf location block's command
...
{/*{{{*/
    ...
    ngx_http_demo_create_conf, /* create location configration */
...
*/
static void demo_process_handler(ngx_http_request_t *r)
{/*{{{*/
    printf( "%s\n", __PRETTY_FUNCTION__ );
    ngx_int_t rc = NGX_OK;
    ngx_buf_t *b = NULL;
    ...
    ngx_http_demo_loc_conf_t *conf = NULL;
    conf = (ngx_http_demo_loc_conf_t *)ngx_http_get_module_loc_conf(r, ngx_http_demo_module);
    if (conf == NULL)
    {
...
{/*{{{*/
    ...
    rc = ngx_http_read_client_request_body( r, demo_process_handler );
...
*/
static char *
ngx_http_demo_set( ngx_conf_t *cf, ngx_command_t *cmd, void *conf )
{/*{{{*/
    printf( "%s\n", __PRETTY_FUNCTION__ );
...
static void *
ngx_http_demo_create_conf(ngx_conf_t *cf)
{/*{{{*/
    printf( "%s\n", __PRETTY_FUNCTION__ );
    ngx_http_demo_loc_conf_t *conf;

    conf = (ngx_http_demo_loc_conf_t *)ngx_pcalloc(cf->pool, sizeof(ngx_http_demo_loc_conf_t));
    if (conf == NULL) {
